...
set rc [catch {
  ...
  add_files -quiet F:/Users/Erwin/Documents/GitHub/DaC/hardware/gpu_zynq/gpu_zynq.runs/synth_1/gpu.dcp
  read_xdc F:/Users/Erwin/Documents/GitHub/DaC/hardware/gpu_zynq/gpu_zynq.srcs/constrs_1/new/gpu.xdc
  link_design -top gpu -part xc7z020clg400-3
...
set rc [catch {
  ...
  catch { write_mem_info -force gpu.mmi }
  write_bitstream -force gpu.bit 
  catch {write_debug_probes -no_partial_ltxfile -quiet -force debug_nets}
  catch {file copy -force debug_nets.ltx gpu.ltx}
